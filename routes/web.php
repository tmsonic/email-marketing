...
Route::group([
    ...
    function() {
        ...
        Route::put('providers/sendy/update', [SendyController::class, 'updateSendy'])->name('sendy.update');
        ...
        Route::put('providers/convertkit/update', [ConvertkitController::class, 'updateConvertkit'])->name('convertkit.update');

        Route::get('providers/sendinblue', [SendinBlueController::class, 'sendinblue'])->name('sendinblue');
        Route::put('providers/sendinblue/update', [SendinBlueController::class, 'updateSendinblue'])->name('sendinblue.update');

        Route::get('providers/getresponse', [GetresponseController::class, 'getresponse'])->name('getresponse');
        Route::put('providers/getresponse/update', [GetresponseController::class, 'updateGetresponse'])->name('getresponse.update');
    }
);
